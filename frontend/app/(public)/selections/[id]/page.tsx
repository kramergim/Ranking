  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Event Header */}
        <div className="mb-8">
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 md:p-10 shadow-xl border border-white/30">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
              {eventData.event_name}
            </h1>
            <p className="text-lg text-gray-600 mb-2">{displayDate}</p>
            {eventData.description && (
              <p className="text-gray-700 mt-3 mb-4 text-lg">{eventData.description}</p>
            )}
        ...
        {!decisions || decisions.length === 0 ? (
          ...
          <div className="bg-white/80 backdrop-blur-lg shadow-xl overflow-hidden rounded-2xl border border-white/40">
